...
public class Transfer implements ObjectFactory {
    ...
    /**
     * Cancels this transfer. {@link #id} must be set.
     */
    ...
    /**
     * Adds the URLs as transfers on the server. These URLs should have been
     * analyzed first through {@link URL#analyze(List)}.
     */

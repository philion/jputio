 ...
 */
class Util {
    private static final DateFormat dateFormat = new SimpleDateFormat("y-m-d H:m:s z");
     ...
     * 
     * @param <T>
     *            Type of instances of objects to create
     * @param results
     *            Result map from server
     * @param klass
